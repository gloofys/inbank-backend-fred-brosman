...
public class DecisionEngineConstants {
    ...
    //Maximum Loan period should be 48 instead of 60
    ...
    public static final Integer ESTONIA_LIFE_EXPECTANCY = 78;
    public static final Integer MAXIMUM_LOAN_PERIOD_IN_YEARS = 4;
}
